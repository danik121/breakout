...
class BreakoutViewController: UIViewController, BreakoutCollisionBehaviorDelegate {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        loadSettings()
        // MARK     PUNT 8
        //  Restart bals bij het return naar de tabblad Breakout van spel
    ...
    override func viewDidLoad() {
        ...
        breakoutView.addGestureRecognizer( UITapGestureRecognizer(target: self, action: "launchBallAndLastBallSpeed:"))
     // MARK: -PUNT 3
    ...
    func launchBallAndLastBallSpeed(gesture: UITapGestureRecognizer){
    ...
    func ballHitBrick(behavior: UICollisionBehavior, ball: BallView, brickIndex: Int) {
        ...
        if breakoutView.bricks.count == 0 {
            ...
            showGameEndedAlert(true, message: "Win!")
        }
    }
    ...
    func ballLeftPlayingField(ball: BallView)
    {
        if(ballsUsed == maxBalls) { // the last ball just left the playing field
            showGameEndedAlert(false, message: "Geen ballen!")
        }
