...
class BreakoutView: UIView {
    ...
    //animator
    //variable animator worden niet geïnitialiseerd zolang iemand niet vraagt naar de animator
    lazy var animator: UIDynamicAnimator = {
        UIDynamicAnimator(referenceView: self)
    }()
    //creëert een fysieke veld werkend op alle actieve objecten die zijn toegevoegd aan het speelveld
